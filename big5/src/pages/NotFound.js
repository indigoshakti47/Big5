...
<Grid container>
  ...
  <img className = "dashboard-3" src = {Dash3} alt="image1"/> 
  </Grid>
  <Grid container item xs={4} md={6} spacing={2}>
  <img className = "dashboard-1" src = {Dash1} alt="image1"/> 
  <img className = "dashboard-2" src = {Dash2} alt="image1"/> 
  <img className = "dashboard-5" src = {Dash5} alt="image1"/> 
  </Grid>
</Grid>
   </>
  )
