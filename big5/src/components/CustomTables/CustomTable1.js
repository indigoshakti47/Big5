  ...
  return !Object.keys(servqual).length > 0 ? <p></p> : (
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>Servperf</StyledTableCell>
        ...
        <TableBody>
          <StyledTableRow key={data[0].name}>
            ...
            <StyledTableCell align="right">{servqual.reliabilityPerceptions}</StyledTableCell>
            <StyledTableCell align="right">{servqual2.reliabilityPerceptions}</StyledTableCell>
          </StyledTableRow>
          <StyledTableRow key={data[1].name}>
            ...
            <StyledTableCell align="right">{servqual.assurancePerceptions}</StyledTableCell>
            <StyledTableCell align="right">{servqual2.assurancePerceptions}</StyledTableCell>
          </StyledTableRow>
          <StyledTableRow key={data[2].name}>
            ...
            <StyledTableCell align="right">{servqual.tangibilityPerceptions}</StyledTableCell>
            <StyledTableCell align="right">{servqual2.tangibilityPerceptions}</StyledTableCell>
          </StyledTableRow>
          <StyledTableRow key={data[3].name}>
            ...
            <StyledTableCell align="right">{servqual.empathyPerceptions}</StyledTableCell>
            <StyledTableCell align="right">{servqual2.empathyPerceptions}</StyledTableCell>
          </StyledTableRow>
          <StyledTableRow key={data[4].name}>
            ...
            <StyledTableCell align="right">{servqual.responsivenessPerceptions}</StyledTableCell>
            <StyledTableCell align="right">{servqual2.responsivenessPerceptions}</StyledTableCell>
          </StyledTableRow>
        </TableBody>
      </Table>
    </TableContainer>
